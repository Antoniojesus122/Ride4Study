...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    if (empty($nombre) || empty($correo)) {
        ...
        try {
            // Obtener datos actuales para comparar y borrar foto antigua si es necesario
...
// ... (El resto de la lógica de cambio de contraseña permanece igual)
...
<div class="min-h-full">
    <!-- Navigation (El resto del nav permanece igual) -->
