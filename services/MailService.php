...
class MailService
{
    ...
    public function generarPlantilla($nombre, $titulo, $contenido, $destacado = null, $urlBoton = null, $textoBoton = 'Ir a Ride4Study')
    {
        ...
        $bloqueDestacado = $destacado ? "
            <div style=\"background-color:#0f172a; padding:20px; border-radius:12px; margin:25px 0; text-align:center; border:1px solid #1e3a2f;\">
                        ...
                        <tr>
                            <td align=\"center\">
                                ...
                                <table width=\"600\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"background-color:#1e293b; border-radius:16px; overflow:hidden; max-width:90%;\">
                                    ...
                                    <!-- HEADER: background-color sólido como fallback para clientes que no soportan gradientes -->
                                    <tr>
                                        <td align=\"center\"
                                            style=\"padding:28px 36px;
                                                   background-color:#34d399;
                                                   background-image:linear-gradient(90deg,#34d399,#22d3ee);\">
                                            <h1 style=\"margin:0; color:#0f172a; font-size:24px; font-weight:bold; letter-spacing:1px;\">
                                                Ride4Study
                                            </h1>
                                        </td>
                                    </tr>
                                    ...
                                    <!-- CONTENIDO -->
                                    <tr>
                                        <td style=\"padding:40px 36px 32px 36px; color:#e2e8f0;\">

                                            <h2 style=\"margin-top:0; font-size:20px; color:#ffffff;\">
                                                {$titulo}
                                            </h2>

                                            <div style=\"height:2px; width:40px; background-color:#34d399; border-radius:2px; margin-bottom:20px;\"></div>

                                            <div style=\"font-size:15px; line-height:1.75; color:#94a3b8;\">
                                                {$contenido}
                                            </div>
