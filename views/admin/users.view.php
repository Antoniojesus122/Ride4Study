                        ...
                        <tr class="border-b border-gray-700/30 hover:bg-gray-800/40 transition">
                            ...
                            <td class="px-5 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <form method="POST" action="<?= url('/admin/users') ?>" class="inline-flex items-center gap-1.5">
                                        <input type="hidden" name="action" value="update_role">
                                        <input type="hidden" name="user_id" value="<?= $u['idUsuario'] ?>">
                                        <select name="new_role" class="px-2.5 py-1.5 bg-gray-900 border border-gray-600 rounded text-sm text-gray-300 focus:outline-none focus:border-primary">
                                        ...
                                        <button type="submit" class="px-3 py-1.5 text-sm font-medium bg-primary/10 text-primary rounded hover:bg-primary/20 transition">Cambiar</button>
                                    </form>
