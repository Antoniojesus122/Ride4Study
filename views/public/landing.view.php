                        ...
                        <div class="space-y-8">
                            ...
                            <div class="pt-8 border-t border-white/5 flex gap-12 text-center sm:text-left">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 uppercase tracking-widest mt-1"><?= t('landing.fees') ?></p>
                                </div>
                                <div>
                                    <p class="text-3xl font-bold text-white">+50</p>
                                    <p class="text-xs text-gray-500 uppercase tracking-widest mt-1"><?= t('landing.daily_routes') ?></p>
                                </div>
                                <div>
                                    <p class="text-3xl font-bold text-white">100%</p>
                                    <p class="text-xs text-gray-500 uppercase tracking-widest mt-1"><?= t('landing.verified') ?></p>
                                </div>
                            </div>
                        </div>
                ...
                <section id="como-funciona" class="py-24 bg-gray-900 relative">
                    <div class="mx-auto max-w-7xl px-6">
                        <div class="text-center mb-16">
                            <h2 class="text-3xl md:text-5xl font-bold mb-6"><?= t('landing.steps_title') ?></h2>
                            <p class="text-gray-400 text-lg max-w-2xl mx-auto"><?= t('landing.steps_desc') ?></p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                            ...
                            <div class="relative group">
                                ...
                                <p class="text-gray-400 text-center"><?= t('landing.step1_desc') ?></p>
                            </div>
                            ...
                            <div class="relative group">
                                ...
                                <p class="text-gray-400 text-center"><?= t('landing.step2_desc') ?></p>
                            </div>
                            ...
                            <div class="relative group">
                                ...
                                <p class="text-gray-400 text-center"><?= t('landing.step3_desc') ?></p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="mx-auto max-w-7xl px-6">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div class="order-1 lg:order-2">
                                <h2 class="text-3xl md:text-5xl font-bold mb-6"><?= t('landing.why_title') ?></h2>
