...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-14 py-8">
    ...
    <?php else: ?>
        <div class="bg-surface rounded-2xl border border-gray-700 overflow-hidden">
            ...
            ?>
            <div class="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-700/50 <?= $isCurrentUser ? 'bg-primary/5 border-l-4 border-l-primary' : '' ?> <?= $position <= 3 ? 'bg-gray-800/30' : '' ?>">
                <!-- Posición -->
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm lg:text-base font-semibold text-white truncate <?= $isCurrentUser ? 'text-primary' : '' ?>">
                ...
                <div class="text-right shrink-0">
                    <p class="text-sm lg:text-base font-bold text-green-400"><?= number_format((float)$user['co2_ahorrado'], 1) ?> kg</p>
