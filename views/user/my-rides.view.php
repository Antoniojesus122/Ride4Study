    ...
    <div class="mb-8 border-b border-gray-700">
        <nav class="-mb-px flex space-x-8" aria-label="Tabs">
            <button onclick="switchTab('active')" id="tab-active" class="border-primary text-primary whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors flex items-center gap-2">
                <i class="fas fa-route"></i> Activos 
...
function switchTab(tab) {
    ...
    if (tab === 'active') {
        ...
        pastTabBtn.classList.replace('border-primary', 'border-transparent');
        pastTabBtn.classList.replace('text-primary', 'text-gray-400');
        ...
        activeTabBtn.classList.replace('border-primary', 'border-transparent');
        activeTabBtn.classList.replace('text-primary', 'text-gray-400');
